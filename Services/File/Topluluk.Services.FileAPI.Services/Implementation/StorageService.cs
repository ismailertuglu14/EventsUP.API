...
namespace Topluluk.Services.FileAPI.Services.Implementation
{
    public class StorageService : IStorageService
    {
        ...
        public async Task<List<string>>  UploadAsync(string containerName, IFormFileCollection formFileCollection) => await _storage.UploadAsync(containerName, formFileCollection);
